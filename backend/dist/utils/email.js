...
exports.getBrandedTemplate = exports.sendEmail = void 0;
...
const sendEmail = async (to, subject, text, html) => {
    try {
        ...
        const fromUser = isEthereal
            ? activeTransporter.options && activeTransporter.options.auth?.user
 ...
 */
const getBrandedTemplate = (title, bodyMessage, buttonText, buttonUrl) => {
...
exports.getBrandedTemplate = getBrandedTemplate;
